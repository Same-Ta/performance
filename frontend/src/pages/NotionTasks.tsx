      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="card flex flex-col items-center py-12 gap-4 text-center">
          <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center">
            <img src="/icons/notion.svg" alt="Notion" className="w-8 h-8" />
          </div>
          <div>
              ...
              >
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3 flex-1 min-w-0">
                    {analysis ? (
                      analysis.isDone ? (
                        <span className="w-5 h-5 flex items-center justify-center text-green-500 flex-shrink-0 mt-0.5">✓</span>
                      ) : (
                        <span className="w-5 h-5 flex items-center justify-center text-brand-400 flex-shrink-0 mt-0.5">○</span>
                      )
                    ) : (
                      <span className="w-5 h-5 flex items-center justify-center text-gray-300 flex-shrink-0 mt-0.5">○</span>
                    )}
